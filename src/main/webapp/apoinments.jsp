				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
							...
							<a class="dropdown-item" href="EmployeeLogoutServelet"> <i
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="row">
						...
						<div class="col-md-6">
							<form id="form" method="post" action="apoinments.jsp"
								class="form-horizontal">

								<div class="form-group">
									<div class="input-group">
										<input type="text" class="form-control" id="search"
											placeholder="Employee ID" name="search">
									...
									<div class="table-responsive">
										<table class="table">
                                            ...
                                            try {
                                                ...
                                                if (search != null ) {
                                                    //String query = "SELECT * FROM apoinment";
                                                    //rs = stmt.executeQuery(query);
                                                 
                                                    //read patient appointment
                                                    String query = "SELECT a.apoinmentId, a.date, a.patient_nic, a.doctor_doctorId, a.masage, d.fname, p.name, a.status " +
													             "FROM apoinment a " +
													             "INNER JOIN doctor d ON a.doctor_doctorId = d.doctorId " +
													             "INNER JOIN patient p ON a.patient_nic = p.nic " +
													             "WHERE a.patient_nic =?";
                                        ...
                                        %>
											<tbody>
												<tr>
													...
													<td>
														<% if (rs.getInt(8) == 1) { %>
														<form action="PayAppoinmentServelet" method="post"
															style="display: inline-block; margin-right: 10px;">
															<input type="hidden" name="appId"
																value="<%=rs.getString(1)%>">
															<button type="submit"
																class="btn btn-success btn-rounded btn-fw">Payment</button>
														</form>
														<button type="button"
															class="btn btn-danger btn-rounded btn-fw"
															onclick="window.location.href='deleteAppoinment.jsp?appId=<%=rs.getString(1)%>'">Delete</button>
														<% } %>
														<button type="button"
															class="btn btn-primary btn-rounded btn-fw"
															onclick="window.location.href='shduledAppoinment.jsp?appId=<%=rs.getString(1)%>'"
															style="display: inline-block; margin-right: 10px;">ReSheduled</button>
